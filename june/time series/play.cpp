...
void update(vector<int> &result, double HitI, mt19937& mt, uniform_real_distribution<double>& u,  Vector<double>& Clock, 
...
void simulate(int thread_num, vector<int> &result, double hitI){
...
void get_random(double* randNumbers, double low, double high, int N){
    ...
    void generateData(vector<vector<int>> &results, double hitIs[]){
    ...
    write_to_disk(results, hitIs, NUM_SAMPLES);
